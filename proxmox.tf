...
# see https://registry.terraform.io/providers/bpg/proxmox/0.95.0/docs/resources/virtual_environment_file
...
resource "terraform_data" "incus_os_seed_data" {
  ...
  triggers_replace = {
    ...
    # see https://github.com/lxc/incus-os/blob/202602100206/incus-osd/api/system_network.go
...
# see https://registry.terraform.io/providers/bpg/proxmox/0.95.0/docs/resources/virtual_environment_vm
